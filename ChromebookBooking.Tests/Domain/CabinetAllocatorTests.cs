...
public class CabinetAllocatorTests
{
    ...
    private readonly int _defaultSectionId = 99;
    private readonly int _defaultTeacherId = 10;
    private readonly int _otherSectionId = 50;
    private readonly int _otherTeacherId = 20;

    private const int FIRST_CLASS_PERIOD = 1;
    private const int SECOND_CLASS_PERIOD = 2;
    private const int THIRD_CLASS_PERIOD = 3;
    ...
    private static Cabinet CreateCabinet(int id, string name)
    {
        var cabinet = new Cabinet(name);
        cabinet.GetType().GetProperty("Id")?.SetValue(cabinet, id);
        return cabinet;
    }
    ...
    public void Allocate_Should_Throw_DomainException_When_All_Cabinets_Are_Booked()
    {
        ...
        var todaysBookings = new List<Booking>
        {
            new Booking(
                date: _defaultDate, 
                classPeriodId: FIRST_CLASS_PERIOD, 
                cabinetId: 1, 
        ...
        // Act
        var action = () =>
            _allocator.Allocate(FIRST_CLASS_PERIOD, _defaultSectionId, activeCabinets, todaysBookings);
    ...
    {
        // Arrange
        var cabinetA = CreateCabinet(1, "Cabinet A");
        var cabinetB = CreateCabinet(2, "Cabinet B");
        ...
        // Act
        var cabinet = _allocator.Allocate(SECOND_CLASS_PERIOD, _defaultSectionId, activeCabinets, todayBookings);
    ...
    public void Allocate_Should_Not_Assign_A_Cabinet_Already_Booked_In_The_Same_Period()
    {
        ...
        var todaysBooking = new List<Booking>
        {
            new Booking(
                ...
                cabinetId: 1,
                teacherId: _defaultTeacherId,
                sectionId: _otherSectionId)
        };

        // Act
        var cabinet = _allocator.Allocate(FIRST_CLASS_PERIOD, _defaultSectionId, activeCabinets, todaysBooking);
    ...
    public void Allocate_Should_Ignore_Cancelled_Bookings_When_Calculating_Availability()
    {
        ...
        var cancelledBooking = new Booking(
            date: _defaultDate,
            classPeriodId: FIRST_CLASS_PERIOD, // Mesmo horário
    ...
    public void Allocate_Should_Prioritize_The_Most_Recently_Used_Cabinet_For_The_Section()
    {
        ...
        var todaysBookings = new List<Booking>
        {
            ...
            new Booking(_defaultDate, FIRST_CLASS_PERIOD, cabinetId: 1, teacherId: _defaultTeacherId, sectionId: _defaultSectionId),
            
            // Turma usou o Cabinet B na 2ª Aula
            new Booking(_defaultDate, SECOND_CLASS_PERIOD, cabinetId: 2, teacherId: _defaultTeacherId, sectionId: _defaultSectionId)
        };

        // Act
        var cabinet = _allocator.Allocate(THIRD_CLASS_PERIOD, _defaultSectionId, activeCabinets, todaysBookings);
    ...
    public void Allocate_Should_Fallback_To_Another_Cabinet_When_Previously_Used_Is_Occupied()
    {
        ...
        var todaysBookings = new List<Booking>
        {
            ...
            new Booking(
                date: _defaultDate,
                classPeriodId: SECOND_CLASS_PERIOD,
                cabinetId: 1,
        ...
        // Act
        var cabinet = _allocator.Allocate(SECOND_CLASS_PERIOD, _defaultSectionId, activeCabinets, todaysBookings);
